...
const CROPS_DATA = {
  wheat: {
    ...
    cost: 5, growthTime: 120, sellPrice: 10, xp: 5, unlockLevel: 1,
    stages: ['🟫', '🌱', '🌿', '🌾'],
  ...
  corn: {
    ...
    cost: 10, growthTime: 300, sellPrice: 22, xp: 10, unlockLevel: 1,
    stages: ['🟫', '🌱', '🌿', '🌽'],
  ...
  carrot: {
    ...
    cost: 15, growthTime: 480, sellPrice: 35, xp: 15, unlockLevel: 2,
    stages: ['🟫', '🌱', '🌿', '🥕'],
  ...
  tomato: {
    ...
    cost: 25, growthTime: 900, sellPrice: 55, xp: 25, unlockLevel: 3,
    stages: ['🟫', '🌱', '🌿', '🍅'],
  ...
  strawberry: {
    ...
    cost: 40, growthTime: 1800, sellPrice: 90, xp: 40, unlockLevel: 5,
    stages: ['🟫', '🌱', '🌿', '🍓'],
  ...
  pumpkin: {
    ...
    cost: 60, growthTime: 3600, sellPrice: 140, xp: 60, unlockLevel: 7,
    stages: ['🟫', '🌱', '🌿', '🎃'],
  ...
  sunflower: {
    ...
    cost: 80, growthTime: 7200, sellPrice: 200, xp: 80, unlockLevel: 10,
    stages: ['🟫', '🌱', '🌿', '🌻'],
  ...
  watermelon: {
    ...
    cost: 120, growthTime: 14400, sellPrice: 320, xp: 120, unlockLevel: 13,
    stages: ['🟫', '🌱', '🌿', '🍉'],
  ...
  cotton: {
    ...
    cost: 150, growthTime: 21600, sellPrice: 400, xp: 150, unlockLevel: 16,
    stages: ['🟫', '🌱', '🌿', '☁️'],
  ...
  rice: {
    ...
    cost: 200, growthTime: 28800, sellPrice: 550, xp: 200, unlockLevel: 20,
    stages: ['🟫', '🌱', '🌿', '🍚'],
