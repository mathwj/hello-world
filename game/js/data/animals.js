...
const ANIMALS_DATA = {
  chicken: {
    ...
    cost: 50, feedRequired: { corn: 2 }, productionTime: 1800,
  ...
  goat: {
    ...
    cost: 150, feedRequired: { wheat: 3 }, productionTime: 7200,
  ...
  sheep: {
    ...
    cost: 250, feedRequired: { corn: 4 }, productionTime: 10800,
  ...
  cow: {
    ...
    cost: 300, feedRequired: { wheat: 5 }, productionTime: 14400,
  ...
  bee: {
    ...
    cost: 200, feedRequired: {}, productionTime: 7200,
  ...
  pig: {
    ...
    cost: 400, feedRequired: { carrot: 5 }, productionTime: 21600,
  ...
  horse: {
    ...
    cost: 800, feedRequired: { wheat: 8 }, productionTime: 28800,
